...
RUN deno cache --import-map=./import-map.json --unstable mod.ts

# Finally run the bot
CMD ["run", "--allow-net", "--allow-read=/bot", "--allow-write=/bot", "--allow-env", "--import-map=import-map.json", "--unstable", "./mod.ts"]
